...
public class SmsUtil {
	 ...
	 */
 	public static void sendSms1(String mobile,String code){
 		String PostData = "";
		try {
			PostData = "account="+SysUtil.SMS_USERNAME+"&password="+SysUtil.SMS_PASSWORD+"&mobile="+mobile+"&content="+URLEncoder.encode(code,"utf-8");
	...
	public static void sendSms2(String mobile,String code){
		...
		NameValuePair[] data = {//提交短信
		    new NameValuePair("account", SysUtil.SMS_USERNAME), 
		    new NameValuePair("password", SysUtil.SMS_PASSWORD), 			//密码可以使用明文密码或使用32位MD5加密
