...
public class PathUtil {
	...
	public static String getClasspath() {
		System.out.println((String.valueOf(Thread.currentThread().getContextClassLoader().getResource("")) + "../../").replaceAll(
				"file:", "").replaceAll("%20", " ").trim());
		return (String.valueOf(Thread.currentThread().getContextClassLoader().getResource("")) + "../../").replaceAll(
				"file:", "").replaceAll("%20", " ").trim();
	}
