...
public class Freemarker {
	...
	public static void printFile(String ftlName, Map<String, Object> root, String outFile,
			String filePath, String ftlPath) throws Exception {
		try {
	...
	public static Template getTemplate(String ftlName, String ftlPath) throws Exception {
		try {
			String classPath = PathUtil.getClassResources();
			
			if(classPath.indexOf("test-classes") != -1){//jetty启动时，目录有所不同
				classPath = PathUtil.getClasspath() + "src/main/resources";
			}
