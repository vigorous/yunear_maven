...
<body>
	<form action="tbuser/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="TBUSER_ID" id="TBUSER_ID" value="${pd.TBUSER_ID}"/>
		<div id="zhongxin">
		<table>
			<tr>
				<td><input type="text" name="USER_NAME" id="USER_NAME" value="${pd.USER_NAME}" maxlength="32" placeholder="这里输入姓名" title="姓名"/></td>
			</tr>
			<tr>
			...
			<tr>
				<td><input type="text" name="PHONE" id="PHONE" value="${pd.PHONE}" maxlength="32" placeholder="这里输入电话号吗" title="电话号吗"/></td>
			</tr>
			<tr>
				<td><input class="span10 date-picker" name="AUDIT_TIME" id="AUDIT_TIME" value="${pd.AUDIT_TIME}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="审核日期" title="审核日期"/></td>
			</tr>
			<tr>
				<td><input class="span10 date-picker" name="CREATE_TIME" id="CREATE_TIME" value="${pd.CREATE_TIME}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="创建日期" title="创建日期"/></td>
			</tr>
			<tr>
				<td><input class="span10 date-picker" name="UPD_TIME" id="UPD_TIME" value="${pd.UPD_TIME}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="修改日期" title="修改日期"/></td>
			</tr>
			<tr>
				<td><input type="text" name="ROLE_TYPE" id="ROLE_TYPE" value="${pd.ROLE_TYPE}" maxlength="32" placeholder="这里输入角色类型" title="角色类型"/></td>
			</tr>
			<tr>
				<td><input type="text" name="ROLE_DESC" id="ROLE_DESC" value="${pd.ROLE_DESC}" maxlength="32" placeholder="这里输入角色描述" title="角色描述"/></td>
			</tr>
			<tr>
