...
<body>
	<form action="tbcopyrightmulti/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="TBCOPYRIGHTMULTI_ID" id="TBCOPYRIGHTMULTI_ID" value="${pd.TBCOPYRIGHTMULTI_ID}"/>
		<div id="zhongxin">
		<table>
			<tr>
			...
			<tr>
				<td><input type="text" name="UPD_TIME" id="UPD_TIME" value="${pd.UPD_TIME}" maxlength="32" placeholder="这里输入上传日期" title="上传日期"/></td>
			</tr>
			<tr>
